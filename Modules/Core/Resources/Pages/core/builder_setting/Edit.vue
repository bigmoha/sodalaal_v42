                            ...
                            <div>
                                <div v-if="title == settingColumn[0].label">
                                    ...
                                    <div class="px-4 py-3">
                                        ...
                                        <a href="https://www.docs.panacea-soft.com/psx-mpc/setup/setup-admin-panel/setup-your-own-api-token" target="_blank" class="underline underline-offset-2 text-primary-500 mt-2 inline-block cursor-pointer">{{ $t("core_be__create_and_update_api_token") }}</a>
                                    </div>
